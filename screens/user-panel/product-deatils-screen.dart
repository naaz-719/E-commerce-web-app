...
import 'package:arts/controllers/rating_controller.dart';
import 'package:arts/models/product-model.dart';
import 'package:arts/models/review_model.dart';
...
// Ensure that the rating is not null or incorrectly set.
print(calculateProductRatingController.averageRating);
  ...
  static Future<void> sendMessageOnWhatsApp({
    ...
    final number = "+91-7710854875";
    final message =
        "Hello Sadaf Arts Studio \n i want to know about this product \n ${productModel.productName} \n ${productModel.productId}";
